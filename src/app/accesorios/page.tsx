    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{
            backgroundImage:
              "url('/images/sliderack/bg/detalle-paneles.jpg')",
        ...
        <section className="bg-white pt-20 pb-6 px-6">
          <div className="mx-auto max-w-[900px]">
            <ScrollReveal>
              ...
              >
                Personaliza y amplía tu sistema
              </h2>
              <p
              ...
              >
                Accesorios diseñados para adaptar tu Sliderack a cualquier necesidad. Cajones, paneles perforados, puestos de trabajo, cerraduras y baldas adicionales. Todos compatibles con cualquier modelo del sistema.
              </p>
            </ScrollReveal>
          </div>
        </section>
        ...
        <section
          ...
          style={{
            backgroundImage: "url('/images/sliderack/photos/herramientas-panel.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
