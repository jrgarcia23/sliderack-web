            ...
            <ScrollReveal>
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  ...
                  <a href={`tel:${PHONE_TEL}`} className="rounded-lg border-2 border-gray-300 px-10 py-4 font-[family-name:var(--font-heading)] text-[16px] font-bold uppercase text-[#201F20] hover:border-[#A52430] hover:text-[#A52430] transition-colors">
                    {phoneDisplay(locale)}
                  </a>
                </div>
              </div>
