          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-3">
                <Link
                  href="/sistemas"
                  className="rounded-lg bg-[#A52430] px-8 py-3.5 text-center font-[family-name:var(--font-heading)] text-[15px] font-bold uppercase text-white hover:bg-[#8a1e28] transition-colors"
                >
                  Explorar sistemas
                </Link>
                <Link
                  href="/"
                  className="rounded-lg border-2 border-gray-300 px-8 py-3.5 text-center font-[family-name:var(--font-heading)] text-[15px] font-bold uppercase text-[#201F20] hover:border-[#A52430] hover:text-[#A52430] transition-colors"
                >
                  Volver al inicio
                </Link>
              </div>
